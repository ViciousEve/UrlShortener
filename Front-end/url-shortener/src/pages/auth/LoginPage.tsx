...
import { Mail, Lock, Eye, EyeOff, Zap, GitBranch } from 'lucide-react'
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      ...
      >
        ...
        <div className="glass-strong p-8 rounded-2xl">
          ...
          <p className="text-sm text-[var(--color-text-muted)] mb-7">Sign in to your account</p>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              id="google-login-btn"
              className="flex items-center justify-center gap-2 py-2.5 glass rounded-xl text-sm text-[var(--color-text-muted)] hover:text-white hover:border-white/20 transition-all"
              disabled
              title="Coming soon"
            >
          ...
          <p className="text-center text-sm text-[var(--color-text-muted)] mt-6">
            ...
            <Link to="/register" className="text-[var(--color-indigo-light)] hover:underline font-medium">
              Sign up free
            </Link>
          </p>
        </div>
